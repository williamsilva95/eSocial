            ...
            <div class="card-header text-right">
                <div class="row">
                    <div class="col-md-6 text-left">
                        ...
                        <a href="{{url('dominio/exportar')}}" class="btn btn-success btn-sm" role="button">Exportar</a>
                    </div>
                    <div class="col-md-6">
                        <form class="form-inline my-lg-0 d-flex justify-content-end" action="{{url('dominio/pesquisar')}}" method="post">
                            {{csrf_field()}}
                        ...
                        @foreach($result as $value)
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <button onClick="deletar('{{ $value->id }}', '{{$value->nome}}', '{{$value->tld}}')" class="btn btn-danger btn-sm " role="button">Deletar</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
